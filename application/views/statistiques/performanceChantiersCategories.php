    ...
    <div class="row">
        <div class="col-12 col-xl-10 offset-xl-1">
            ...
            if (!$this->uri->segment('3')):
                echo '<div class="row fond"><div class="col-12 text-center">Selectionnez une catégorie de chantier pour affchier les performances liées.</div></div>';
            else:
                ?>
                <div class="row fond">
                    ...
                    <div class="col-12 col-md-8 col-lg-9">
                        <canvas  style="border: 1px solid slategray; margin:5px;" id="graphPerformances" max-width = "400" height="150"
                                 chart-labels = "<?= $perfsLabels; ?>"
                                 chart-performances = "<?= $perfs; ?>"
                                 chart-performancesN = "<?= $perfsN; ?>"
                                 chart-categorieid = "<?= $categorieAnalyse->getCategorieId(); ?>"
                                 chart-title="<?= $categorieAnalyse->getCategorieNom(); ?>"></canvas>
                    </div>
                </div>
                <div class="row fond">
