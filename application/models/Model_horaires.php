...
class Model_horaires extends MY_model {
    ...
    public function ajouter(Horaire $horaire) {
        $this->db
                ->set('horaireNom', $horaire->getRsNom())
                ->set('horaireEtablissementId', $horaire->getRsInscription())
                ...
                ->set('horaireLunAM', $horaire->getHoraireLunAM())
                ->set('horaireLunPM', $horaire->getHoraireLunPM())
                ->set('horaireLun', $horaire->getHoraireLun())
                ...
                ->set('horaireMarAM', $horaire->getHoraireMarAM())
                ->set('horaireMarPM', $horaire->getHoraireMarPM())
                ->set('horaireMar', $horaire->getHoraireMar())
                ...
                ->set('horaireMerAM', $horaire->getHoraireMerAM())
                ->set('horaireMerPM', $horaire->getHoraireMerPM())
                ->set('horaireMer', $horaire->getHoraireMer())
                ...
                ->set('horaireJeuAM', $horaire->getHoraireJeuAM())
                ->set('horaireJeuPM', $horaire->getHoraireJeuPM())
                ->set('horaireJeu', $horaire->getHoraireJeu())
                ...
                ->set('horaireVenAM', $horaire->getHoraireVenAM())
                ->set('horaireVenPM', $horaire->getHoraireVenPM())
                ->set('horaireVen', $horaire->getHoraireVen())
                ...
                ->set('horaireSamAM', $horaire->getHoraireSamAM())
                ->set('horaireSamPM', $horaire->getHoraireSamPM())
                ->set('horaireSam', $horaire->getHoraireSam())
                ...
                ->set('horaireDimAM', $horaire->getHoraireDimAM())
                ->set('horaireDimPM', $horaire->getHoraireDimPM())
                ->set('horaireDim', $horaire->getHoraireDim())
                ->set('horaireTotal', $horaire->getHoraireTotal())
                ->insert($this->table);
        $horaire->setRsId($this->db->insert_id());
    }
